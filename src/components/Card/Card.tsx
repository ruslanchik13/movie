...
function Card({ title, date, genres, text, url, average, movieId, guestId, id, stars = 0 }: CardProps) {
      ...
      <div className={classes.info}>
        <div className={classes.container}>
          <div className={classes.header}>
            ...
            <div className={classes.rating} style={{ border: `2px solid ${colorAverage(average)}` }}>
          ...
          <div className={classes.text}>{text.split(' ').slice(0, 15).join(' ')}...</div>
          <Rate
            value={stars || value}
            allowHalf
